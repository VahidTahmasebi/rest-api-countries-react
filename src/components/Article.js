...
const Article = ({ flags, name, population, region, subregion }) => {
  return (
    <>
      <article className='bg-white hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 rounded-lg'>
        <img src={flags.svg} alt='' className='md:h-72 w-full object-cover' />
        <div className='p-4'>
          <h2 className='text-left font-bold text-lg text-gray-900 dark:text-white mb-2'>
            {name.common}
          </h2>
